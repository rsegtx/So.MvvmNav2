...
namespace MvvmNav.Core.Mvvm
{
    public class MvxNavigationService1 : IMvxNavigationService
    {
        ...
        public MvxNavigationService1(IMvxNavigationCache navigationCache, IMvxViewModelLoader viewModelLoader)
        {
        ...
        protected async Task<MvxViewModelInstanceRequest> NavigationRouteRequest(string path, IMvxBundle presentationBundle = null)
        {
            ...
            if (viewModelType.GetInterfaces().Contains(typeof(IMvxNavigationFacade)))
            {
                ...
                try
                {
                    ...
                    // Inspect object returned from NavigationFacade, if it is a 
                    // ViewModelInstanceRequest then use it as is.
